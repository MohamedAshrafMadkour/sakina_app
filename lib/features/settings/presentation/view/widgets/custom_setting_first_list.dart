...
class CustomSettingFirstList extends StatelessWidget {
  const CustomSettingFirstList({
    super.key,
  });
      ...
      child: CustomSettingsItemContainer(
        child: Column(
          children: List.generate(
            SettingModel.firstSettingList.length,
            (index) => Column(
              children: [
                CustomSettingListTile(
                  setting: SettingModel.firstSettingList[index],
                ),
                Visibility(
